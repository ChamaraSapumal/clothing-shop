    ...
    <div>
      <div className="container">
        ...
        <div className="container mt-lg-4">
          ...
          <h6 className="fw-medium line-space">
          ...
          <br />
          <h6 className="fw-medium line-space d-none d-md-block">
            Introducing Handy Clothing, where our philosophy revolves around
            celebrating individuality through fashion. Established in [year],
            Handy Clothing is a proud subsidiary of Brandix Lanka Limited, a
            distinguished name in the apparel industry with over 50 years of
      ...
      <div className="container mt-lg-5">
        ...
        <h6 className="fw-medium line-space mt-4">
          Introducing Handy Clothing, where our philosophy revolves around
          celebrating individuality through fashion. Established in [year],
          Handy Clothing is a proud subsidiary of Brandix Lanka Limited, a
          distinguished name in the apparel industry with over 50 years of
      ...
      <div className="container pt-5">
        <div className="row">
          <div className="col-4">
            ...
            <h5>Devify Clothing &#40;PTV&#41; LDT.</h5>
            <h5>No. 25, Rheinland Place, Colombo.</h5>
            <h5>20986</h5>
          </div>
          <div className="col-4">
            <h3 className="fw-semibold">Customer Care Hotline</h3>
            <h5>+94 112224456</h5>
            <a href="#" className="h5 text-dark-emphasis">
